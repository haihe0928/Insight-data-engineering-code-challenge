...
//three steps to draw venmo graph
//step 1 draw the line between actor and target
//step 2 draw oral for each person
//step 3 draw name on each oral
//the graph can shrink as more payments in a short time
